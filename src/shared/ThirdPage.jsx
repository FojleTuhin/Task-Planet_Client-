        ...
        <div>
            <div className="w-[425px] min-h-screen bg-blue-500 mx-auto">
                ...
                <div className="bg-white h-screen rounded-t-[30px] py-[15px] px-5 pt-[30px]">
                    <input type="email" name="email" id="email"  placeholder="Email"  className="w-full border-[1px] border-b-[#aaa] py-[7px] px-[9px] bg-[#f5f5f5] mb-7 text-[11px] "/> <br />
                   <input type="password" name="password" id="password" placeholder="Password" className="w-full border-[1px] border-b-[#aaa] py-[7px] px-[9px] bg-[#f5f5f5] text-[11px]"/>
